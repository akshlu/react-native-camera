...
type PropsType = typeof View.props & {
  ...
  focusPointOfInterest?: { x: number, y: number },
  exposurePointOfInterest?: { x: number, y: number },
...
export default class Camera extends React.Component<PropsType, StateType> {
  ...
  static propTypes = {
    ...
    focusPointOfInterest: PropTypes.shape({ x: PropTypes.number, y: PropTypes.number }),
    exposurePointOfInterest: PropTypes.shape({ x: PropTypes.number, y: PropTypes.number}),
